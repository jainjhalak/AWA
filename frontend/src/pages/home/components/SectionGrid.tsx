  ...
  return (
    <div className="mb-8">
      <div className="flex items-center justify-between mb-4">
        ...
        <Button variant="link" className="text-sm text-lime-300 hover:text-white">Show All</Button>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {songs.map((song) => (
          <div
            key={song._id}
            className="bg-lime-950 p-4 rounded-md hover:bg-green-900 transition-all group cursor-pointer" >
              ...
              <h3 className="font-medium mb-2 truncate text-lime-100">{song.title}</h3>
